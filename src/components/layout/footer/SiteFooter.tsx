...
export function SiteFooter() {
  return (
    <footer className="bg-navy-900 tablet:rounded-t-[60px] w-full rounded-t-[32px] text-white">
      <div className="layout-shell pb-5 pt-8 tablet:pb-8 tablet:pt-[60px]">
        <div className="layout-container flex flex-col items-start gap-10 tablet:items-center tablet:gap-[140px]">
          <section
