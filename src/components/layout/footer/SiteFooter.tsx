...
export function SiteFooter() {
  return (
    <footer className="bg-navy-900 tablet:rounded-t-[60px] w-full rounded-t-[32px] text-white">
      <div className="tablet:items-center tablet:gap-[140px] tablet:px-20 tablet:pb-8 tablet:pt-[60px] mx-auto flex w-full max-w-[var(--layout-container-lg)] flex-col items-start gap-10 px-5 pt-8 pb-5">
        <section
