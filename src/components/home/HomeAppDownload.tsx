  ...
  return (
    ...
    >
      <SectionPanelLayout>
        ...
        <div className="tablet:grid-cols-3 mt-10 grid gap-6">
          {[0, 1, 2].map((i) => (
            <article
              key={i}
            ...
            >
              <div className="typo-body6 mx-auto flex size-(--size-app-store-icon) items-center justify-center rounded-2xl bg-gray-100 text-gray-500">
                App
              </div>
              <h3
                id={`app-card-${i}-title`}
              ...
              <div className="typo-body6 mt-6 flex aspect-square max-w-(--size-app-qr-max) items-center justify-center self-center rounded-lg bg-gray-200 text-gray-500">
                QR（佔位）
              </div>
            </article>
          ))}
